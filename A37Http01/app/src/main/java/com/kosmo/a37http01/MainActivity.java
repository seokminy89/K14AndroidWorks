...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnJson.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                첫번째 인수로 접속 URL을 전달한다. execute() 호출을 통해 doInBackground()가
                호출된다.
                 */
                new AsyncHttpRequest().execute(
                        "http://내아이피주소:8081/jsonrestapi/android/memberList.do");
            }
        });
        /*
        HTTP통신 시작시 진행대화상자를 띄우기 위해 객체를 생성한다.
        스타일, 아이콘, 타이틀 등의 설정을 진행한다.
        특히 setCalcelable()은 물리버튼(Back버튼)을 눌렀을때 대화창이 닫히지 않도록
        설정한다.
         */
    ...
    class AsyncHttpRequest extends AsyncTask<String,Void,String>
    {
        ...
        protected String doInBackground(String... strings) {
            ...
            try{
                //가변인자를 통해 받은 0번째 인수를 통해URL객체를 생성한다.
                ...
                out.flush();
                out.close();
                //서버에 요청이 전달되고 성공이라면 HTTP_OK로 확인할 수 있다.
            ...
            //파싱된 모든 내용을 반환한다. 반환된 값은 onPostExecute로 전달된다.
