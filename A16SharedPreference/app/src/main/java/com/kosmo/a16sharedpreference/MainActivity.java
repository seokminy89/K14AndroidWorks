...
SharedPreferences
    ...
    자동로그인, 게임스코어유지, 앱의 마지막 상태 저장등에 사용된다.
*/
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        /*
        저장된 값을 가져와서 입력상자에 설정한다. 만약 저장된 값이 없을경우에는
        디폴트값으로 두번째 인자에 지정된 값을 사용할 수 있다.
         */
        String id = pref.getString("id", "저장된ID없음");
    ...
    public void  btnLoginClicked(View v){
        ...
        //토스트를 띄워줌
        Toast.makeText(getApplicationContext(), "아이디/비번 저장됨", Toast.LENGTH_SHORT).show();;
    }
}