...
public class MainActivity extends AppCompatActivity {
    ...
    AsyncTask
        ...
        UI에 대한 비동기 작업을 자동으로 실행해주며 개발자가 직접 핸들러 클래스를
        만들 필요가 없다. 실행은 execute()메소드를 호출하면 된다.
        전달할 파라미터가 있는경우 execute(파라미터) 형식으로 사용한다.
    형식]AsyncTask<Param, Progress, Result>
    ...
    */
    class CounterTask extends AsyncTask<Integer,Integer,Integer>{
        ...
        //Integer 다음에 오는 ...은 문법임. 가변인자를 쓰겠다는.
        /*
        ...
        /*
        doInBackground() 메서드 실행 중 언제든지 호출할 수 잇는 메서드로
