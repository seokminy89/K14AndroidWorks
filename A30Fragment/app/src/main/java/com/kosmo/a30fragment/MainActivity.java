...
public class MainActivity extends AppCompatActivity {
    ...
    //프래그먼트 사용을 위한 관리자 객체와 화면교체용 프래그먼트 객체 생성
    ...
    /*
    프래그먼트1은 별도의 자바클래스가 아닌 메인액티비티의 내부 클래스로 정의한다.
    프래그먼트 정의시 별도의 클래스로 정의하는 방법과 내부클래스로 정의하는 방법
    2가지 모두 사용할 수 있다.
    별도로 제작할 경우 Fragment 클래스를 상속한 onCreateView() 메서드를 오버라이딩한다.
    ...
    public static class MyFragment1 extends Fragment{
        ...
        public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            /*
            자바코드로 프래그먼트를 붙일경우 세번째 인자는 false로 기술해야 한다.
            ...
            button1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    /*
                    프래그먼트 교체시 번들객체를 통해 전달된 데이터를 아래와 같이 받아서
                    사용할 수 있다. 위에 onCreate 에서 setArguments()로 보내면
                    아래처럼 getArguments()받아서 사용한다.
                     */
