...
public class MainActivity extends AppCompatActivity {
    ...
    class RequestThread extends Thread{
        ...
        public void run() {
            for(int i=0; i<20; i++){
                ...
                이때 앱은 강제종료된다. 서브쓰레드의 접근이 메인쓰레드의 동작에
                영향을 미칠 수 있으므로 접근을 원천적으로 제한하기 때문이다.

                ANR이란?
                    ANR은 Aplication Not Responding의 약자로 그대로 해석해보면
    ...
    /*
    핸들러 클래스 생성
        :메인 쓰레드에서 생성한 UI(위젯)는 서브쓰레드에서 접근할 수 없으므로
    ...
    class ProgressHandler extends Handler{
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            쓰레드의 동작이 끝나기 전에는 버튼을 누를 수 없도록 비활성화 상태를 유지한다.
            */
            if(data2.equals("19")){
