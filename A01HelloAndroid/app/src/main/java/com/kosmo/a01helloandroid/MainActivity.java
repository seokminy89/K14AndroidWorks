...
public class MainActivity extends AppCompatActivity {
    ...
    */
    ...
    /*
    Java에서의 출발점은 main()메서드이듯, 안드로이드의 출발점은 onCreate()메서드이다.
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        해당 메서드가 실행되지 않으면 화면에는 아무것도 보이지 않게 된다.
         */
        ...
        findViewById(res에 설정한 id값)
            ...
            res폴더는 resource의 줄임말로 접근시에는 R객체를 사용한다
            (ex=> R.id.btnNate)
         */
        ...
        btnNate.setOnClickListener(new View.OnClickListener(){
            /*
            View.OnClickListener() 인터페이스는 onClick() 추상 메서드를 포함하고 있으므로
            반드시 아래 메서드를 오버라이딩 해야한다.(아니면 에러남.)
             */
            @Override
            public void onClick(View v) {
                /*
                버튼을 누르면 토스트 메세지를 띄워준다. 토스트는 JS의 alert와 유사하게
                메시지를 일정시간 보여준 뒤 사라진다.
        ...
        //화면 전환 버튼을 눌렀을때 내부의 SubActivity를 띄워준다.
    ...
    View.OnClickListener listener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            /*
            버튼을 누를때 전달되는 View객체를 통해 눌러진 버튼의 id를 알아낼 수 있다.
             */
    ...
    리스너 부착3 : 버튼의 onclick속성을 이용한다. 이때 호출할 메서드명을 기술하면
        해당 메서드를 즉시 호출할 수 있다.
        단, 메서드 선언시 매개변수로 View객체를 반드시 사용해야 한다.
     */
